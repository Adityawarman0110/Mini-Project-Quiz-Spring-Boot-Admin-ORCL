	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="#" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>M</b><b>U</b><b>F</b></span> <!-- logo for regular state and mobile devices -->
				<img src="${pageContext.request.contextPath }/resources/dist/img/muf.png" height="55px">
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="${pageContext.request.contextPath }/resources/dist/img/pp.png"
								class="user-image" alt="User Image"> <span
								class="hidden-xs">Aditya Warman Agustian</span>
						</a>
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									...
									<p>
										Aditya Warman Agustian - Web Developer <small>Karyawan
											Mandiri Utama Finance</small>
									</p></li>
								<!-- Menu Body -->
								<!-- Menu Footer-->
								<li class="user-footer">
									...
									<div class="pull-right">
										<a href="${pageContext.request.contextPath }/" class="btn btn-default btn-flat" onclick="if (!(confirm('Apa Kamu Yakin Ingin Sign Out?'))) return false">Sign out</a>
									</div>
								</li>
							</ul></li>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="${pageContext.request.contextPath }/member"><i
							class="fa fa-user-o "></i> Member</a></li>
					<li><a href="${pageContext.request.contextPath }/asset"><i
							class="fa fa-ioxhost "></i> Asset</a></li>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2019 <a href="https://adminlte.io">Admin
					Mandiri Utama Finanace</a>.
